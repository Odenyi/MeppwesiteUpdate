...
<head>
    ...
    <meta charset="utf-8" />
    <title>Add Swipper | Upbond - Admin & Dashboard</title>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0">Add Swipper Image</h4>

                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item"><a href="javascript: void(0);">Mepp</a></li>
                                    <li class="breadcrumb-item active">Add Swipper Image</li>
                                </ol>
                            </div>
                                    ...
                                    <ul class="twitter-bs-wizard-nav">
                                        ...
                                        <li class="nav-item">
                                            <a href="#product-img" class="nav-link" data-toggle="tab">
                                                ...
                                                <span class="step-title">Swiper Images</span>
                                            </a>
                                        </li>
